...
const TerceiraTrilogia = () => {
  ...
  return (
    <ImageBackground source={require('./assets/terceira.jpg')} style={styles.background}>
      <View style={styles.container}>
        <Text style={styles.title}>Terceira Trilogia</Text>
        <Text style={styles.description}>
          A terceira trilogia de Star Wars inclui os filmes:
          "O Despertar da Força", "Os Últimos Jedi" e "A Ascensão Skywalker".
        </Text>
      </View>
    </ImageBackground>
  );
...
export default TerceiraTrilogia;
