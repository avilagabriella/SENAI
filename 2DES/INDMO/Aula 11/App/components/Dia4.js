...
const Dia4 = () => {
  ...
  return (
    <ImageBackground source={require('./assets/Dia4.jpg')} style={styles.background}>
      <View style={styles.container}>
        <Text style={styles.title}>Dia 4</Text>
        <Text style={styles.description}>
          "May the 4th be with you!" - Celebre o Dia de Star Wars, também conhecido como Dia 4 de maio.
        </Text>
      </View>
    </ImageBackground>
  );
